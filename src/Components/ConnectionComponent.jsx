...
import { FaTwitter, FaLinkedin, FaGithub, FaSquareUpwork } from "react-icons/fa6";
      ...
      <div className="space-y-3 sm:space-y-4">
        ...
        <div className="flex sm:hidden items-center justify-between">
          ...
          <a href={link} target="_blank" rel="noopener noreferrer">
            <button className={`px-3 py-2 text-sm font-medium text-white ${bgColor} rounded-lg hover:opacity-90 transition-colors flex items-center justify-center`}>
