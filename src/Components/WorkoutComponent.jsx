    ...
    <div className="bg-[#F2D2BD] p-4 md:p-6 lg:p-8 text-white">
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-8 justify-between md:ml-8 md:mr-8 lg:ml-20 lg:mr-20 mt-4 md:mt-20">
        ...
        <div className="flex-1">
          <h2 className="text-xl md:text-2xl lg:text-3xl pl-2 md:pl-4 text-[#A0522D]">
            I lift every day
          </h2>
          <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold text-[#4A0404] mt-2 md:mt-4">
            And I go Super
          </h1>
        </div>
        ...
        <div className="flex-1 mt-4 md:mt-0">
          <p className="text-lg md:text-xl lg:text-2xl text-[#A0522D] md:text-center">
            Workouts are a part of my routine. They help me stay physically fit
            and also keep me sane while trying to develop great products.
          </p>
        </div>
      </div>
