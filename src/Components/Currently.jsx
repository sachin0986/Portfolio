...
const Currently = () => {
    ...
    const fullDescription = "🥗 Reps & Recipes is a MERN-based food ordering web application, offering a wide range of healthy, high-protein meal options tailored to individual diet plans.";
    const truncatedDescription = "🥗 Reps & Recipes is a MERN-based food ordering web application.";
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-10 md:gap-16 p-6 sm:p-10 md:p-16 pt-10 sm:pt-16 md:pt-24">
        {/* Image Section - Full width on mobile, half width on md screens and up */}
                      ...
                      <div className="w-full md:w-1/2 space-y-4 sm:space-y-6 text-center md:text-left">
                        ...
                        <div className="pt-2">
                          <Link to="/caseStudy/RepsandRecipies" onClick={() => window.scrollTo(0, 0)}>
