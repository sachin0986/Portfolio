    ...
    <div className="px-6 py-8 md:px-12 md:py-12 lg:pl-24 lg:pt-24 text-white w-full md:w-[90%] lg:w-1/2 mx-auto">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mt-2 leading-tight">
          I pull my controller <br className="hidden md:inline" /> to slay gods or kick goals
        </h1>
      </div>
      ...
      <div className="flex items-center gap-4 md:gap-6 mb-6 md:mb-8">
        ...
        />
        <div>
          <h3 className="text-base md:text-lg lg:text-xl text-gray-400">All-time favourite</h3>
          <h1 className="text-lg md:text-xl lg:text-2xl font-bold mt-1">God of War series</h1>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 md:gap-6">
        ...
        />
        <div>
          <h3 className="text-base md:text-lg lg:text-xl text-gray-400">Most hours spent</h3>
          <h1 className="text-lg md:text-xl lg:text-2xl font-bold mt-1">BGMI</h1>
        </div>
      </div>
    </div>
