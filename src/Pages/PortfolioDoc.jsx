        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 sm:gap-6 md:gap-8 w-full mb-6 sm:mb-8">
            <div className="w-full md:w-2/5">
              ...
              />
              <p className="mt-2 sm:mt-3 text-gray-600 font-medium text-base sm:text-lg">Initial Design</p>
            </div>
            ...
            <div className="w-full md:w-2/5">
              <img 
                ...
                className="w-full h-auto rounded-lg shadow-md"
              />
              <p className="mt-2 sm:mt-3 text-gray-600 font-medium text-base sm:text-lg">Final Design</p>
            </div>
          </div>
          
          {/* Key improvements box */}
          <div className="bg-gray-50 p-4 sm:p-6 md:p-8 rounded-lg max-w-3xl mx-auto shadow-sm w-full">
            <h3 className="font-semibold text-lg sm:text-xl mb-3 sm:mb-4 text-gray-800">Key Improvements:</h3>
      ...
      <section className="mb-12 sm:mb-16 md:mb-24">
        ...
        <div className="flex flex-col md:flex-row gap-6 sm:gap-8 md:gap-10">
          ...
          <div className="w-full md:w-1/2">
            <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-gray-800">Integrating GitHub Repositories</h3>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 sm:gap-6 w-full mb-8 sm:mb-10">
            <div className="w-full md:w-2/5">
              <img 
                ...
                className="w-full h-auto rounded-lg shadow-md"
              />
              <p className="mt-2 sm:mt-3 text-center text-gray-600 font-medium text-base sm:text-lg">Dynamic Image Transformations</p>
            </div>
            ...
            <div className="w-full md:w-2/5">
              <img  
                ...
                className="w-full h-auto rounded-lg shadow-md"
              />
              <p className="mt-2 sm:mt-3 text-center text-gray-600 font-medium text-base sm:text-lg">Cloudinary Asset Management</p>
            </div>
          </div>

          {/* Implementation benefits - stacked grid on mobile */}
          <div className="mt-6 sm:mt-8 md:mt-10 max-w-3xl mx-auto">
            <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-center text-gray-800">Implementation Benefits</h3>
            <div className="bg-gray-50 p-4 sm:p-6 md:p-8 rounded-lg shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                <div>
                  <h4 className="font-semibold text-lg sm:text-xl mb-3 sm:mb-4 text-gray-800">Performance Improvements</h4>
                  <ul className="list-disc pl-5 sm:pl-6 text-gray-700 space-y-2 sm:space-y-3 text-base sm:text-lg">
                ...
                <div className="mt-4 md:mt-0">
                  <h4 className="font-semibold text-lg sm:text-xl mb-3 sm:mb-4 text-gray-800">Developer Experience</h4>
                  <ul className="list-disc pl-5 sm:pl-6 text-gray-700 space-y-2 sm:space-y-3 text-base sm:text-lg">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 sm:gap-6 w-full mb-8 sm:mb-10 md:mb-12">
          <div className="w-full md:w-2/5">
            <img 
              ...
              className="w-full h-auto rounded-lg shadow-md"
            />
            <p className="mt-2 sm:mt-3 text-center text-gray-600 font-medium text-base sm:text-lg">Previous: Netlify Deployment</p>
          </div>
          ...
          <div className="w-full md:w-2/5">
            <img 
              ...
              className="w-full h-auto rounded-lg shadow-md"
            />
            <p className="mt-2 sm:mt-3 text-center text-gray-600 font-medium text-base sm:text-lg">Current: Vercel Deployment</p>
          </div>
        </div>

        {/* Comparison and Explanation */}
        <div className="mb-6 sm:mb-8 md:mb-10">
          <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 md:mb-8 text-center text-gray-800">Why I Switched to Vercel</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-md border border-gray-100">
              <h4 className="font-semibold text-lg sm:text-xl mb-3 sm:mb-4 text-red-600">Netlify Limitations</h4>
              <ul className="list-disc pl-5 sm:pl-6 text-gray-700 space-y-2 sm:space-y-3 text-base sm:text-lg">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-md border border-gray-100">
              <h4 className="font-semibold text-lg sm:text-xl mb-3 sm:mb-4 text-green-600">Vercel Advantages</h4>
              <ul className="list-disc pl-5 sm:pl-6 text-gray-700 space-y-2 sm:space-y-3 text-base sm:text-lg">
        ...
        <div className="mt-6 sm:mt-8 md:mt-10 p-4 sm:p-6 md:p-8 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg border border-gray-200 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 text-center">
            <div className="bg-white/50 p-4 rounded-lg">
              <p className="text-3xl sm:text-4xl md:text-5xl font-bold text-green-600 mb-2 sm:mb-3">43%</p>
              <p className="text-gray-700 text-base sm:text-lg">Faster build times</p>
            </div>
            <div className="bg-white/50 p-4 rounded-lg">
              <p className="text-3xl sm:text-4xl md:text-5xl font-bold text-green-600 mb-2 sm:mb-3">68%</p>
              <p className="text-gray-700 text-base sm:text-lg">Improved load times</p>
            </div>
            <div className="bg-white/50 p-4 rounded-lg">
              <p className="text-3xl sm:text-4xl md:text-5xl font-bold text-green-600 mb-2 sm:mb-3">99.9%</p>
              <p className="text-gray-700 text-base sm:text-lg">Uptime reliability</p>
            </div>
          </div>
        </div>
      </section>
