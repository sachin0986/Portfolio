...
const ContactMePage = () => {
  ...
  return (
    <div className="min-h-screen bg-black p-4 sm:p-6 md:p-12 lg:p-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="inline-block px-3 py-1.5 sm:px-4 sm:py-2 bg-[#1E1E1E] rounded-full">
              <span className="text-sm sm:text-base text-[#BFFF00]">Contact Info</span>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="space-y-3 sm:space-y-4">
                <a href="tel:+918655898414" className="flex items-center gap-2 sm:gap-3 bg-[#1E1E1E] p-3 sm:p-4 rounded-xl">
                  ...
                  <span className="text-sm sm:text-base text-white">+91 8279480784</span>
                </a>
                <a href="mailto:purplerain.studio08@gmail.com" className="flex items-center gap-2 sm:gap-3 bg-[#1E1E1E] p-3 sm:p-4 rounded-xl">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#BFFF00] rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <span className="text-sm sm:text-base text-white truncate">sachinarora.8279@gmail.com</span>
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#1E1E1E] p-6 sm:p-8 rounded-3xl border border-[#BFFF00]/20">
            <div className="space-y-4 sm:space-y-6">
              <div>
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-4">Get a quote</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                <div>
                  <label className="block text-sm sm:text-base text-gray-400 mb-1 sm:mb-2">Name</label>
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
                ...
                <div>
                  <label className="block text-sm sm:text-base text-gray-400 mb-1 sm:mb-2">Email</label>
                  <input
                    type="email"
                    name="email"
                ...
                <div>
                  <label className="block text-sm sm:text-base text-gray-400 mb-1 sm:mb-2">Location</label>
                  <select
                    name="location"
                ...
                {status === 'success' && (
                  <p className="text-sm sm:text-base text-green-400 text-center">Message sent successfully!</p>
                )}
                {status === 'error' && (
                  <p className="text-sm sm:text-base text-red-400 text-center">Something went wrong. Please try again.</p>
                )}
              </form>
            </div>
          </div>
      ...
      <div className=''>
        <h2 className='text-2xl sm:text-4xl md:text-5xl lg:text-6xl text-center font-bold pt-10 sm:pt-16 md:pt-20 text-[#BFFF00]'>Let's Weave Connections Together !</h2>
      </div>
